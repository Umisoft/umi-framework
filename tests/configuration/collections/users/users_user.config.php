...
return [
    ...
    'fields'     => [
        ...
        'login'                 => ['type'       => IField::TYPE_STRING,
                                    'columnName' => 'login',
                                    'accessor'   => 'getLogin',
                                    'mutator'    => 'setLogin',
                                    'validators' => ['required' => []]
        ],
        'email'                 => ['type'       => IField::TYPE_STRING,
                                    'columnName' => 'email',
                                    'validators' => ['email' => []]
        ],
        'password'              => ['type'       => IField::TYPE_PASSWORD,
                                    'columnName' => 'password',
                                    'accessor'   => 'getPassword',
                                    'mutator'    => 'setPassword'
        ],
        'isActive'              => ['type' => IField::TYPE_BOOL, 'columnName' => 'is_active', 'defaultValue' => 1],
        'rating'                => ['type'         => IField::TYPE_REAL,
                                    'dataType'     => 'float',
                                    'columnName'   => 'rating',
                                    'defaultValue' => 0
        ],
        'height'                => ['type'       => IField::TYPE_INTEGER,
                                    'columnName' => 'height',
                                    'validators' => ['required' => [], 'regexp' => ['pattern' => '/[0-9]{2,3}/']]
        ],
        'group'                 => ['type'       => IField::TYPE_BELONGS_TO,
                                    'columnName' => 'group_id',
                                    'target'     => 'users_group'
        ],
        'profile'               => ['type'        => IField::TYPE_HAS_ONE,
                                    'target'      => 'users_profile',
                                    'targetField' => 'user'
        ],
        'blogs'                 => ['type'        => IField::TYPE_HAS_MANY,
                                    'target'      => 'blogs_blog',
                                    'targetField' => 'owner'
        ],
        'subscription'          => ['type'         => IField::TYPE_MANY_TO_MANY,
                                    'target'       => 'blogs_blog',
    ...
    'types'      => [
        'base'       => [
            'objectClass' => 'utest\orm\mock\collections\users\User',
            'fields'      => [
        ...
        'supervisor' => [
            'objectClass' => 'utest\orm\mock\collections\users\Supervisor',
            'fields'      => [
                IObject::FIELD_IDENTIFY,
                IObject::FIELD_GUID,
                IObject::FIELD_TYPE,
