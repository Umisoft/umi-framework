...
/**
 * Тест поля для чисел с фиксированной точностью и масштабом.
 */
class DecimalFieldTest extends FieldTestCase
{

    /**
     * @var DecimalField $field
     */
    protected $field;

    protected function setUpFixtures()
    {
        $this->field = new DecimalField('decimal');
    }
