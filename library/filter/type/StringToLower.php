...
/**
 * Фильтр преобразует строку к нижнему регистру.
 * Преобразует строковое значение к нижнему регистру.
 */
class StringToLower implements IFilter
{
    ...
    public function filter($var)
    {
        ...
        return mb_strtolower($var, $encoding);
    }
}