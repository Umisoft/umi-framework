 ...
 */
    ...
    class DbCluster implements IDbCluster, ILocalizable
    {
        ...
        {
            return $this->getMaster()->insert($tableName, $isIgnore);
        }
        ...
        {
            return $this->getMaster()->update($tableName, $isIgnore);
        }
        ...
        {
            return $this->getMaster()->delete($tableName);
        }
        ...
        {
            return $this->getSlave()->selectInternal($sql, $params);
        }
        ...
        {
            return $this->getMaster()->modifyInternal($sql, $params);
        }
        ...
        {
            return $this->getMaster()->getConnection();
        }
